    ...
    public class ParserToOats {
        ...
        private void STEPS () {
            ...
            while (currState != null) {
                ...
                Assert.IsTrue (action.Name.Length > 0, "Action is empty!");

                Assert.IsNotNull (trans, "Trans is null!");

                if (!action.Name.Equals ("initialState") || !action.Name.Equals ("finalState")) {
                    //Assert.IsTrue(trans.Count() > 0, "Trans is empty!");
                }
#endif
                ...
                foreach (UmlTransition t in trans) {
                    ...
                    if (TDobject != null && !TDobject.Equals ("")) {
                        ...
                        else if (TDobject.Equals ("window"))
